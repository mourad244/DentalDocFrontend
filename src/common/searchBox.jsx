...
const SearchBox = ({ value, onChange, width = 170, height = 35, onSearch }) => {
  return (
    <div className="flex items-center ">
      <input
        className=" rounded-md bg-[#D6E1E3] pl-2 pr-9 text-xs font-medium shadow-inner focus:outline-none"
        type="text"
      ...
      {
        /* value.length === 0 ? */ <svg
          className="z-1 -ml-8 cursor-pointer"
          width="25"
          onClick={onSearch}
          height="20"
          viewBox="0 0 25 27"
