...
import "./recuPaiement.css";
import { NumberToLetter } from "convertir-nombre-lettre";

const RecuPaiement = (props) => {
  ...
  const { selectedPatient, natureActes } = props;
  ...
  return (
    <div className="print-content recu-paiement">
      ...
      >
        <div ref={componentRef}>
          <div className="doc  recu-paiement ">
            ...
            <div className="identite">
              <div className="identite-item">
                <label className="identite-item-title">DOSSIER N°:</label>
                <label> {selectedPatient.numOrdre}</label>
              </div>
              <div className="identite-item">
                <label className="identite-item-title">NOM:</label>
                <label>{selectedPatient.nom}</label>
              </div>
              <div className="identite-item">
                <label className="identite-item-title">PRENOM:</label>
                <label>{selectedPatient.prenom}</label>
              </div>
              <div className="identite-item">
                <label className="identite-item-title identite-item-title-decale ">
                  ACTE:
                </label>
                <label>
                  {natureActeId
                    ? natureActes.find((nature) => nature._id === natureActeId)
                        .nom
                    : ""}
                </label>
              </div>
              <div className="identite-item  identite-item-title-cadre">
                <label className="identite-item-title">
                  RECU N° :{"   "}
                  {numRecu + "/" + dateNow.getFullYear().toString().substr(-2)}
                </label>
                <label></label>
              </div>
              <div className="identite-item">
              ...
              <div className="identite-item">
                ...
                <label>
                  {montant
                    ? NumberToLetter(montant).toUpperCase() + " DIRHAMS"
                    : ""}{" "}
                </label>
              </div>
            </div>
            <div className="inline-info-bottom">
              <div className="renseignement-cheque">
                <div className="renseignement-cheque-item">
                  Chèque N°: .......................
                </div>
                <div className="renseignement-cheque-item">
                  Compte N°: .......................
              ...
              <div className="signature">
                <h3>
                  Fait à : Rabat le {dateNow.getDate()}/{dateNow.getMonth() + 1}
                  /{dateNow.getFullYear()}
                </h3>
                <h3>Signature :..............................</h3>
              </div>
          ...
          <div className="doc  recu-paiement recu-paiement-colore">
            <div className="attache">
              <h3>ROYAUME DU MAROC</h3>
              <h3>FORCES ARMEES ROYALES</h3>
              <h3>ETAT MAJOR GENERAL</h3>
